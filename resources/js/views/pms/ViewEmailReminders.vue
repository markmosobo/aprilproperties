        ...
        <div class="col-12">
          <div class="card top-selling overflow-auto">
            ...
            <div class="card-body pb-0">
              <h5 class="card-title">E-mail Reminders for {{tenant}} <span>| #{{refNo}}</span></h5>
              <p class="card-text">
              ...
              <table id="AllUsersTable" class="table table-borderless">
                ...
                <tbody>
                  <tr v-for="item in emailreminders" :key="item.id">
                    <td>{{ item.subject }}</td>
...
export default {
  ...
  methods: {
    ...
    getReminders() {
      axios.get('/api/emailreminders/'+ this.$route.params.id)
        .then((response) => {
          this.emailreminders = response.data.emailreminders;
