                ...
                <div class="col-12">
                  <div class="card top-selling overflow-auto">
                    ...
                    <div class="card-body pb-0">
                      <h5 class="card-title">Rented Units <span>| Rented units</span></h5>
                      <p class="card-text"> 
                      <div class="row">
                      ...
                      <table id="AllPropertiesTable" class="table table-borderless">
                        ...
                        <tbody>
                          <tr v-for="unit in rentedunits" :key="unit.id">
                            <!--<th scope="row"><a href="#">
                            ...
                            <td>
                              <span v-if="unit.status == 0" class="badge bg-warning text-dark"><i class="bi bi-exclamation-triangle me-1"></i> Vacant</span>   
                              <span v-else-if="unit.status == 1" class="badge bg-success"><i class="bi bi-check-circle me-1"></i> Rented</span>
    ...
    export default {
      ...
      methods: {
        ...
        loadLists() {
             ...
             this.rentedunits = response.data.lists.rentedunits;
