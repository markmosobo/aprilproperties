                ...
                <div class="col-12">
                  <div class="card top-selling overflow-auto">
                    ...
                    <div class="card-body pb-0">
                      <h5 class="card-title">{{property.name}} Statement <span>| All Time</span></h5>
                      <p class="card-text">
                      ...
                      <table id="AllStatementsTable" class="table table-borderless">
                        ...
                        <tbody>
                          <tr v-for="statement in statements" :key="statement.id">
                            ...
                            <td>{{statement.tenant.first_name}} {{statement.tenant.last_name}}</td>                          <td>{{formatNumber(statement.total)}}</td>
