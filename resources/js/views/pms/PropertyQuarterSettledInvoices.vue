    ...
    export default {
      ...
      methods: {
          ...
          const receiptHTML = `
            ...
            <body>
              <div class="receipt">
                ...
                <div class="receipt-title">Quarterly Rent Statement</div>
        ...
        getInvoices() {
             ...
             this.commercialpropertyquarterinvoices = response.data.commercialpropertyquarterinvoices;
             this.residentialpropertyquarterinvoices = response.data.residentialpropertyquarterinvoices;
        ...
        getProperty()
        {
          axios.get('/api/pmsproperty/'+ this.$route.params.id).then((response) => {
            ...
            if(this.commission !== null)
            {
              ...
              this.commercialPropertyAmount = ((this.commission/100) * this.commercialpropertyquarterinvoices);
              this.residentialPropertyAmount = ((this.commission/100) * this.residentialpropertyquarterinvoices);
            ...
            else
            {
              ...
              this.commercialPropertyAmount = this.commercialpropertyquarterinvoices - this.propertyCommission;
              this.residentialPropertyAmount = this.residentialpropertyquarterinvoices - this.propertyCommission;
