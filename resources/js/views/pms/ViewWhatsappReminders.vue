        ...
        <div class="col-12">
          <div class="card top-selling overflow-auto">
            ...
            <div class="card-body pb-0">
              <h5 class="card-title">Whatsapp Reminders for {{tenant}} <span>| #{{refNo}}</span></h5>
              <p class="card-text">
              ...
              <table id="AllUsersTable" class="table table-borderless">
                ...
                <tbody>
                  <tr v-for="item in whatsappreminders" :key="item.id">
                    <td>{{ item.subject }}</td>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <p><strong>Recipient:</strong> 0{{ phoneNumber }}</p>
...
export default {
  ...
  methods: {
    ...
    getReminders() {
      axios.get('/api/whatsappreminders/'+ this.$route.params.id)
        .then((response) => {
          this.whatsappreminders = response.data.whatsappreminders;
