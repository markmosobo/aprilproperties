    ...
    export default {
      ...
      methods: {
          ...
          const receiptHTML = `
            ...
            <body>
              <div class="receipt">
                ...
                <div class="receipt-title">Last 90 Days Rent Statement</div>
        ...
        getInvoices() {
             ...
             this.commercialpropertylastninetyinvoices = response.data.commercialpropertylastninetyinvoices;
             this.residentialpropertylastninetyinvoices = response.data.residentialpropertylastninetyinvoices;
        ...
        getProperty()
        {
          axios.get('/api/pmsproperty/'+ this.$route.params.id).then((response) => {
            ...
            if(this.commission !== null)
            {
              ...
              this.commercialPropertyAmount = ((this.commission/100) * this.commercialpropertylastninetyinvoices);
              this.residentialPropertyAmount = ((this.commission/100) * this.residentialpropertylastninetyinvoices);
            ...
            else
            {
              ...
              this.commercialPropertyAmount = this.commercialpropertylastninetyinvoices - this.propertyCommission;
              this.residentialPropertyAmount = this.residentialpropertylastninetyinvoices - this.propertyCommission;
