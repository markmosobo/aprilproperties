...
<!--                       <router-link to="/add-pmslandlord" custom v-slot="{ href, navigate, isActive }">
                      ...
                      <div class="row">
                        <div class="col d-flex">
                          ...
                          <button v-if="allstatements.length !== 0" @click="printInvoice" class="me-2">Print Invoice</button>
    ...
    export default {
      ...
      methods: {
          ...
          const receiptHTML = `
            ...
            <body>
              <div class="receipt">
                ...
                <div class="receipt-title">${this.lastYear || 'Last Year'} Rent Statement</div>
        ...
        getLastYear() {
          const now = new Date();
          return now.getFullYear() - 1; // Return the last year
        },
        getCurrentDate() {
          const now = new Date();
        ...
        loadLists()
        {
          axios.get('/api/lists').then((response) => {
             ...
             this.mobileMoney = this.payments[0];
             this.bankMoney = this.payments[1];
             this.contacts = response.data.lists.contacts[0];
             // this.tillMoney = response.data.lists.tillpayment;
             // console.log("pussy", this.tillMoney)
        ...
        getInvoices() {
             ...
             this.commercialpropertylastyearinvoices = response.data.commercialpropertylastyearinvoices;
             this.residentialpropertylastyearinvoices = response.data.residentialpropertylastyearinvoices;
        ...
        getProperty()
        {
          axios.get('/api/pmsproperty/'+ this.$route.params.id).then((response) => {
            ...
            if(this.commission !== null)
            {
              ...
              this.commercialPropertyAmount = ((this.commission/100) * this.commercialpropertylastyearinvoices);
              this.residentialPropertyAmount = ((this.commission/100) * this.residentialpropertylastyearinvoices);
            ...
            else
            {
              ...
              this.commercialPropertyAmount = this.commercialpropertylastyearinvoices - this.propertyCommission;
              this.residentialPropertyAmount = this.residentialpropertylastyearinvoices - this.propertyCommission;
