<template>
       ...
       <div class="card-body">
          ...
          <fieldset v-if="step == 1">
             ...
             <div class="row m-auto p-auto justify-content- g-3 needs-validation" novalidate="" autocomplete="off">
                ...
                <div class="row mb-3"></div>
                <div v-if="showLandlordDiv" class="form-group row">
                   <input
                      type="hidden"
                      id="user_id"
                      name="user_id"
                   ...
                   <div class="col-sm-12">
                      ...
                      <div class="col-sm-10">
                      <!--    <select name="landlord" v-model="form.landlord_id" class="form-select" id="landlord">
                            <option value="0" selected disabled>Select Landlord</option>
                            <option v-for="landlord in landlords" :value="landlord.id"
                            :selected="landlord.id == form.landlord_id" :key="landlord.id">{{ landlord.first_name}} {{ landlord.last_name}} - {{ landlord.phone_no}}</option>
 
                         </select> -->
                          <div class="multiselect-searchable">
                            <input type="text" v-model="searchQuery" placeholder="Search Landlords..." class="search-input" />
                            <div class="row mb-3"></div>                                                        
                            <select v-model="form.selectedLandlords" multiple class="form-select" id="landlord">
                              ...
                              <option v-for="landlord in filteredLandlords" :key="landlord.id" :value="landlord.phone_no">
                  ...
                  <div class="col-sm-12">
                    <button class="btn btn-sm btn-primary" style="background-color: green; border-color: green;" type="button" @click="toggleSelectedLandlords">
                      {{ showSelectedLandlords ? 'Hide' : 'Show' }} Selected Landlord Phone Numbers ({{ form.selectedLandlords.length }})
                    </button>
                    <div v-show="showSelectedLandlords" class="selected-tenants mt-2">
                      <ul class="list-group">
                        <li v-for="(landlord, index) in form.selectedLandlords" :key="index" class="list-group-item d-flex justify-content-between align-items-center">
                          {{ landlord }}
                          <button class="btn btn-danger btn-sm" @click="removeLandlord(index)">Remove</button>
                        </li>
                      </ul>
                ...
                <div v-if="showTenantDiv" class="form-group row">
                   <input
                      type="hidden"
                      id="user_id"
                      name="user_id"
                ...
                <div class="form-group row">
                   ...
                   <div class="col-sm-12">
                      ...
                      <div class="col-sm-10">
                        <textarea v-model="form.message" id="message" class="form-control" style="height: 100px"></textarea>
 ...
 export default {
    ...
    data () {
       return {
         ...
         form:
         {
          ...
          searchQuery: '',
          searchTenantQuery: '',
          showLandlordDiv: false, // Add this data property
    ...
    methods: {
      ...
      toLandlords() {
          this.showLandlordDiv = true; // Show the div when "To Landlords" is clicked
          this.showTenantDiv = false; // Hide the div when "To Tenants" is clicked
      },
